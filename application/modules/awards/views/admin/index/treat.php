...
/** @var \Modules\Awards\Mappers\Awards $awardsMapper */
    ...
    <div class="row mb-3<?=$this->validation()->hasError('rank') ? ' has-error' : '' ?>">
        ...
        <div class="col-xl-1">
            <input type="number"
                   ...
                   min="1"
                   placeholder="1"
                   value="<?=$this->originalInput('rank', $award->getRank()) ?>" />
        </div>
    </div>
        ...
        <div class="col-xl-4">
            <div class="input-group">
                <input type="text"
                       ...
                       value="<?=$this->originalInput('image', $award->getImage()) ?>" />
                <span class="input-group-text">
    ...
    <div class="row mb-3<?=($this->validation()->hasError('event')) ? ' has-error' : '' ?>">
        ...
        <div class="col-xl-4">
            <input type="text"
                   ...
                   id="event"
                   name="event"
                   value="<?=$this->originalInput('event', $award->getEvent()) ?>" />
        </div>
    </div>
    <div class="row mb-3<?=$this->validation()->hasError('page') ? ' has-error' : '' ?>">
        ...
        <div class="col-xl-4">
            <input type="text"
                   ...
                   id="page"
                   placeholder="https://"
                   value="<?=$this->originalInput('page', $award->getURL()) ?>" />
        </div>
    </div>
