                    ...
                    <div class="row chat-wrapper">
                        <div class="col-12 col-md-5 col-xl-4<?=$this->get('dialog') ? ' hidden-list-message' : '' ?>">
                            ...
                            <div class="slimScrollDiv chat-list-scroll<?=$this->get('dialog') ? '' : ' noscroll' ?>">
                                ...
                                <div class="slimScrollBar" style="width: 7px; position: absolute; top: 0; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 100%; background: rgb(0, 0, 0);"></div>
                                ...
                                <div class="compose-box">
                                    <div class="row">
                                        <div class="col-12 chat-textarea<?=(empty($this->get('dialog')->getId())) ? ' disabled' : '' ?>">
                                            ...
                                            <button class="btn btn-primary btn-sm float-end" id="chatSendBtn" style="z-index: 11">
    ...
    if (urlPathArray[urlPathArray.length - 2] === 'id' && Number.isInteger(parseInt(urlPathArray[urlPathArray.length - 1]))) {
        ...
        $( window ).on( "load", function() {
            $(document).ready(function() {
                ...
                let editorInstance = document.querySelector( '.ck-editor__editable' ).ckeditorInstance;
                ...
                document.getElementById("chatSendBtn").onclick = function () {
                    let token = document.body.querySelector('[name="ilch_token"]').value;
                    let post_data = {'text':editorInstance.getData(), 'ilch_token':token};
