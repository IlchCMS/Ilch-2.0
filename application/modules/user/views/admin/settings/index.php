<form class="form-horizontal" method="POST" action="<?php echo $this->url(array('action' => $this->getRequest()->getActionName())); ?>">
    <legend><?php echo $this->trans('menuSettings'); ?></legend>
    <?php echo $this->getTokenField(); ?>
    <div class="form-group">
        <label for="regist_accept" class="col-lg-2 control-label">
            <?php echo $this->trans('acceptUserRegis'); ?>:
        </label>
        <div class="col-lg-4">
            <label class="checkbox-inline">
                <input type="radio" 
                       ...
                       <label for="regist_accept_yes"><?php echo $this->trans('yes'); ?></label>
            </label>
            <label class="checkbox-inline">
                <input type="radio"
                       name="regist_accept"
                       ...
                       <label for="regist_accept_no"><?php echo $this->trans('no'); ?></label>
            </label>
        </div>
    </div>
    <div class="form-group">
        <label for="regist_confirm" class="col-lg-2 control-label">
            <?php echo $this->trans('confirmRegistrationEmail'); ?>:
        </label>
        <div class="col-lg-4">
            <label class="checkbox-inline">
                <input type="radio" 
                       ...
                       <label for="regist_confirm_yes"><?php echo $this->trans('yes'); ?></label>
            </label>
            <label class="checkbox-inline">
                <input type="radio"
                       name="regist_confirm"
                       ...
                       <label for="regist_confirm_no"><?php echo $this->trans('no'); ?></label>
            </label>
        </div>
    </div>
    <div class="form-group">
