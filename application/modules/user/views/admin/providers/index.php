            ...
            <tbody>
                <?php foreach ($this->get('providers') as $provider) : ?>
                    <tr>
                        ...
                        <td><i class="fa-solid <?= $provider->getIcon() ?>"></i> <?=$this->escape($provider->getName()) ?></td>
                        <td>
                            <?php if (empty($provider->getModule())) : ?>
                                <span class="text-danger">
                                    <i class="fa-solid fa-xmark"></i> <?= $this->getTrans('providersNoModuleSelectedOrInstalled') ?>
                                </span>
                            <?php else : ?>
                                <span class="text-success">
                                    <i class="fa-solid fa-check"></i> <b><?=$this->escape($provider->getModuleName()) ?></b> (<?= $provider->getModule() ?>)
                                </span>
                            <?php endif; ?>
                        </td>
                    </tr>
