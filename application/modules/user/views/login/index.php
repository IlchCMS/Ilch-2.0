...
if ($this->getUser() == null) : ?>
    ...
    <form id="loginForm" name="loginForm" action="<?=$this->getUrl(['module' => 'user', 'controller' => 'login', 'action' => 'index']) ?>" method="post">
        ...
        <?php if (!empty($this->get('captchaNeeded')) && $this->get('captchaNeeded') && ($this->get('defaultcaptcha') ?? null)): ?>
        ...
        <div class="row mb-3">
            <div class="offset-xl-2 col-xl-10">
                ...
                if (!empty($this->get('captchaNeeded')) && $this->get('captchaNeeded')) {
                    if ($this->get('googlecaptcha') ?? null) {
                        echo $this->get('googlecaptcha')->setForm('loginForm')->getCaptcha($this, 'login', 'Login');
                    } else {
                        ?>
