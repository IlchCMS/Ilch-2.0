...
<form class="form-horizontal" method="POST">
    ...
    <div class="row form-group mb-3 <?=$this->validation()->hasError('name') ? 'has-error' : '' ?>">
    ...
    <div class="row form-group mb-3">
        <label for="assignedGroupsRead" class="col-lg-2 control-label">
            <?=$this->getTrans('see') ?>
            <a href="#" data-bs-toggle="tooltip" title="<?=$this->getTrans('seetext') ?>"><i class="fa-solid fa-circle-info"></i></a>
        </label>
        <div class="col-lg-4">
