...
<form class="form-horizontal" method="POST" action="">
    <?=$this->getTokenField() ?>
    <div class="row form-group mb-3 <?=$this->validation()->hasError('paragraph') ? 'has-error' : '' ?>">
    ...
    <div class="row form-group mb-3 <?=$this->validation()->hasError('title') ? 'has-error' : '' ?>">
    ...
    <div class="row form-group mb-3 <?=$this->validation()->hasError('cat') ? 'has-error' : '' ?>">
    ...
    <div class="row form-group mb-3 <?=$this->validation()->hasError('groups') ? 'has-error' : '' ?>">
    ...
    <div class="row form-group mb-3 <?=$this->validation()->hasError('text') ? 'has-error' : '' ?>">
