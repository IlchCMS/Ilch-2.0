...
<a href="<?=$this->getUrl('statistic/index/show/year/' . $date->format('Y', true) . '/month/' . $date->format('m', true)) ?>"><?=$this->getTrans('statMonth') ?>: <?=$this->get('visitsMonth') ?></a><br />
<a href="<?=$this->getUrl('statistic/index/show/year/' . $date->format('Y', true)) ?>"><?=$this->getTrans('statYear') ?>: <?=$this->get('visitsYear') ?></a><br />
