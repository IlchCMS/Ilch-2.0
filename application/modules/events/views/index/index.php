...
<?php if ($this->get('eventListUpcomings') == '' && $this->get('eventListCurrents') == '' && $this->get('eventListPasts') == '') : ?>
...
<?php if ($this->get('eventListUpcomings') != '') : ?>
        ...
        <div class="col-xl-12">
            <ul class="event-list">
                <?php if ($this->get('eventListUpcomings') != '') : ?>
                    ...
                    foreach ($this->get('eventListUpcomings') as $event) : ?>
...
<?php if ($this->get('eventListCurrents') != '') : ?>
    ...
    <div class="row">
        <div class="col-xl-12">
            <ul class="event-list">
                <?php
                /** @var \Modules\Events\Models\Events $event */
                foreach ($this->get('eventListCurrents') as $event) : ?>
                    <?php $eventEntrants = $entrantsMapper->getEventEntrantsById($event->getId()) ?>
                    <?php $date = new \Ilch\Date($event->getStart()); ?>
                    <?php $agree = 0;
                    $maybe = 0; ?>
