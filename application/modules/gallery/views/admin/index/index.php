...
?>
<form class="form-horizontal" id="galleryForm" method="POST" action="<?php echo $this->getUrl(array('action' => $this->getRequest()->getActionName())); ?>">
<?php echo $this->getTokenField(); ?>
    <legend><?php echo $this->getTrans('gallery'); ?></legend>
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    <select id="type" class="form-control">
                        ...
                        <option value="1"><?php echo $this->getTrans('gallery'); ?></option>
                    </select>
                </div>
            </div>
            <div class="dyn"></div>
...
<script>
    <?php echo $this->getMediaModal(
            $mediaButton = $this->getUrl('admin/media/iframe/multi/type/multi/id/'),
