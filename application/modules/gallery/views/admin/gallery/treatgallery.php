                    ...
                    foreach ($this->get('image') as $image) : ?>
                        <tr>
                            ...
                            <?php if (file_exists($image->getImageThumb())) : ?>
                                <td><img class="image img-thumbnail img-fluid" src="<?=$this->getUrl() . '/' . $image->getImageThumb() ?>" alt="<?=$this->escape($image->getImageTitle()) ?>"/></td>
                            <?php else : ?>
                                <td><img class="image img-thumbnail img-fluid" src="<?=$this->getBaseUrl('application/modules/media/static/img/nomedia.png') ?>" alt="<?=$this->getTrans('noMediaAlt') ?>"/></td>
                            <?php endif; ?>
