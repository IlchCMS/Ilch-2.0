...
(4, 1, 30, 1, 0, 0, '', 3, 'Kontakt', '', 'contact'),
(5, 1, 40, 1, 0, 0, '', 3, 'Links', '', 'link'),
(6, 1, 50, 1, 0, 0, '', 3, 'Partner werden', '', 'partner'),
(7, 1, 60, 1, 0, 0, '', 3, 'Impressum', '', 'impressum'),
(8, 1, 70, 0, 0, 0, 'login', 4, 'Login', '', ''),
(9, 1, 80, 0, 0, 0, 'layoutswitch', 4, 'Layout', '', '');
