<div id="dup">
    <div id="duplicater">
        ...
        <div class="form-group">
            <label class="col-lg-2 control-label" for="textinput"><?=$this->getTrans('warResult'); ?>
            </label>
            <div class="col-lg-2">
...
<script>
    ...
    function del(event)
    {
        ...
        $('#games').load('<?php echo $this->getUrl('index.php/admin/war/ajax/del/id/'.$this->getRequest()->getParam('id').'/mapid/'); ?>'+mapid);
    }
</script>
