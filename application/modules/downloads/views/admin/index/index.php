...
?>
<form class="form-horizontal" id="downloadsForm" method="POST" action="<?php echo $this->getUrl(array('action' => $this->getRequest()->getActionName())); ?>">
<?php echo $this->getTokenField(); ?>
    <legend><?php echo $this->getTrans('downloads'); ?></legend>
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    <select id="type" class="form-control">
                        <option value="0"><?php echo $this->getTrans('cat'); ?></option>
                        <option value="1"><?php echo $this->getTrans('downloads'); ?></option>
                    </select>
                </div>
            </div>
            <div class="dyn"></div>
            <div class="col-lg-offset-3 actions">
                <input type="button" id="menuItemAdd" value="<?php echo $this->getTrans('downloadsItemAdd'); ?>" class="btn">
            </div>
        </div>
