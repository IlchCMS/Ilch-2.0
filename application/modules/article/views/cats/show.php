        ...
        <div>
            ...
            <?php if ($this->get('article_articleRating')) : ?>
                ...
                <?php if ($this->getUser() && in_array($this->getUser()->getId(), $votes) == false) : ?>
                    <a class="btn btn-sm btn-outline-secondary btn-hover-success" href="<?=$this->getUrl(['id' => $article->getId(), 'action' => 'vote', 'from' => 'show', 'catId' => $this->getRequest()->getParam('id')]) ?>" title="<?=$this->getTrans('iLike') ?>">
