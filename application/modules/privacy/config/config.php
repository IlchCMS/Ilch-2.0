...
class Config extends \Ilch\Config\Install
{
    ...
    public function getInstallSql()
    {
        return 'CREATE TABLE IF NOT EXISTS `[prefix]_privacy` (
                ...
                INSERT INTO `[prefix]_privacy` (`title`, `urltitle`, `url`, `text`) VALUES
