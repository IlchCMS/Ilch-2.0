...
return [
    ...
    'designBackgroundColor' => 'Background color of the messages',
    'designTextColor' => 'Text color of the messages',
    'designNameColor' => 'Color for names and links',
    'designBoxBackgroundColor' => 'Background color of the box',
    'designButtonColor' => 'Button color in the box',
    'designButtonTextColor' => 'Button text color in the box',
    'designInputBackgroundColor' => 'Background color of the input fields',
    'designInputTextColor' => 'Text color of the input fields',
    'designFontSize' => 'Font size of the messages in pixels (0 = theme default)',
