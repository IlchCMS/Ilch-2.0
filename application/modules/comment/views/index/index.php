	...
	<?php foreach($comments as $comment): ?>
		<?php if($this->getRequest()->getParam('id') == $comment->getId()): ?>
			...
			<article class="row" id="<?=$comment->getId() ?>">
				<div class="col-md-2 col-sm-2 hidden-xs"><figure class="thumbnail">
				...
				<?php if($this->getRequest()->getParam('id') == $comment->getFKId()): ?>
					...
					<article class="row" id="<?=$comment->getId() ?>">
						...
						<div class="col-md-10 col-sm-10"><div class="panel panel-default arrow left"><div class="panel-bodylist">
							...
							<div class="comment-post"><p><?=nl2br($this->escape($comment->getText())) ?></p></div>
							<p class="text-right"><a href="<?=$this->getUrl(array('module' => 'comment', 'action' => 'index', 'id' => $comment->getId())) ?>" class="btn btn-default btn-sm"><i class="fa fa-reply"></i> reply</a></p>
						</div></div></div>
					</article>
				<?php endif; ?>
			<?php endforeach; ?>
